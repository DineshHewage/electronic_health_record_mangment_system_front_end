...
function Hba1c6({closeParent}) {
    ProtectiveRoute()
    const thArray = ["USER ID", "REPORT ID" , "PATENT NAME","NIC","REPORT DATE","HBA1C6","ACTION"];
    ...
    const [hba1c6, setHba1c6] = useState(0);
    ...
    const handlehba1c6 = (event) => {
        setHba1c6(event.target.value);
    };
    ...
    const loadReportData = () => {
        axios.get(`${BASE_URL}/api/v2/reports/Hba1c6Report?nic=${patientNic}`, AuthConfig())
            .then((res) => {
    ...
    const handleSearch = (event) => {
        axios.get(`${BASE_URL}/api/v2/reports/findAllHba1c6By?nic=${patientNic}`, AuthConfig())
            .then((res) => {
    ...
    const handleHba1c6Save = (event) =>{
        event.preventDefault()
        const formData = new FormData();
        formData.append('hba1c6', hba1c6);
        formData.append('patientId', patientId);
        formData.append('reportedDate', reportedDate);
        formData.append('report', file);

        axios.post(`${BASE_URL}/api/v2/reports/addHba1c6`, formData, AuthConfig())
            .then((res) => {
                alert("HBA1C6 was successfully added")
                setRefresh(false)
    ...
    const handleView = (id) => {
        ...
        axios.get(`${BASE_URL}/api/v2/reports/hba1c6?id=${id}`, AuthConfig())
            .then((res) => {
                setHba1c6(res.data.hba1c6)
    ...
    const handleDeleteFbs = (id) =>{
        axios.post(`${BASE_URL}/api/v2/reports/removeHba1c6?hba1c6=${id}`,{}, AuthConfig())
            .then((res) => {
                                        ...
                                        <div>
                                            <div className="card" style={{ border: '1px solid rgba(135, 206, 250, 1)' }}>
                                                <div className="card-body">
                                                    <h5 className="card-title">HBA1C6 FORM</h5>
                                                    <hr/>
                                                    <form onSubmit={handleHba1c6Save} >

                                                        <div className="row">

                                                            <div className="col-6">
                                                                <div className="form-group">
                                                                    <label htmlFor="fbs">HBA1C6 value</label>
                                                                    <input disabled={disabled} type="number" required onChange={handlehba1c6} value={hba1c6} className="form-control" id="examplefbs"
                                                                           placeholder="enter hba1c6"></input>
                                                                </div>
