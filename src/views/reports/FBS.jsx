...
function FBS({closeParent}) {
    ...
    const loadReportData = () => {
        axios.get(`${BASE_URL}/api/v2/reports/fbsReport?nic=${patientNic}`, AuthConfig())
            .then((res) => {
    ...
    const handlefbsSave = (event) =>{
        ...
        axios.post(`${BASE_URL}/api/v2/reports/addFbs`, formData, AuthConfig())
            .then((res) => {
                alert("FBS was successfully added")
                setRefresh(false)
    ...
    const handleView = (id) => {
        ...
        axios.get(`${BASE_URL}/api/v2/reports/fbs?id=${id}`, AuthConfig())
            .then((res) => {
                setFbs(res.data.fbs)
                                        ...
                                        <div>
                                            <div className="card" style={{ border: '1px solid rgba(135, 206, 250, 1)' }}>
                                                <div className="card-body">
                                                    <h5 className="card-title">FBS FORM</h5>
                                                    <hr/>
                                                    <form onSubmit={handlefbsSave} >
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6">
                                                                <div className="form-group">
                                                                    ...
                                                                    <input disabled={disabled} type="number" required onChange={handlefbsc} value={fbs} className="form-control" id="examplefbs"
                                                                           placeholder="enter fbs"></input>
                                                                </div>
