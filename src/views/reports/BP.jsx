...
function BP({closeParent}) {
    ProtectiveRoute()
    const thArray = ["USER ID", "REPORT ID" , "PATENT NAME","NIC","REPORT DATE","BP","ACTION"];
    ...
    const handleSearch = (event) => {
        axios.get(`${BASE_URL}/api/v2/reports/findAllBpBy?nic=${patientNic}`, AuthConfig())
            .then((res) => {
    ...
    const handleBpSave = (event) =>{
        ...
        axios.post(`${BASE_URL}/api/v2/reports/addBp`, formData, AuthConfig())
            .then((res) => {
                alert("BP was successfully added")
                setRefresh(false)
    ...
    const handleView = (id) => {
        ...
        axios.get(`${BASE_URL}/api/v2/reports/bp?id=${id}`, AuthConfig())
            .then((res) => {
                setBp(res.data.bp)
    ...
    const handleDeleteFbs = (id) =>{
        axios.post(`${BASE_URL}/api/v2/reports/removeBp?bpId=${id}`,{}, AuthConfig())
            .then((res) => {
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6">
                                                                <div className="form-group">
                                                                    ...
                                                                    <input disabled={disabled} type="number" required onChange={handlebpc} value={bp} className="form-control" id="examplefbs"
                                                                           placeholder="enter bp"></input>
                                                                </div>
