...
function DietPlan({closeParent}) {
    ProtectiveRoute()
    const thArray = ["USER ID", "REPORT ID" , "PATENT NAME","NIC","REPORT DATE","START DATE" , "END DATE","ACTION"];
    ...
    //     axios.get(`${BASE_URL}/api/v2/reports/bpReport?nic=${patientNic}`, AuthConfig())
    //         .then((res) => {
    ...
    const handleSearch = (event) => {
        axios.get(`${BASE_URL}/api/v2/reports/findAllDietBy?nic=${patientNic}`, AuthConfig())
            .then((res) => {
    ...
    const handleDietSave = (event) =>{
        ...
        axios.post(`${BASE_URL}/api/v2/reports/addDiet`, formData, AuthConfig())
            .then((res) => {
                alert("Diet plan was successfully added")
                setRefresh(false)
    ...
    const handleView = (id) => {
        ...
        axios.get(`${BASE_URL}/api/v2/reports/diet?id=${id}`, AuthConfig())
            .then((res) => {
    ...
    const handleDeleteFbs = (id) =>{
        axios.post(`${BASE_URL}/api/v2/reports/removeDiet?dietId=${id}`,{}, AuthConfig())
            .then((res) => {
                                        ...
                                        <div>
                                            <div className="card" style={{ border: '1px solid rgba(135, 206, 250, 1)' }}>
                                                <div className="card-body">
                                                    <h5 className="card-title">Diet Plan FORM</h5>
                                                    <hr/>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6">
                                                                <div className="form-group row">
                                                                    <label htmlFor="dob" className="col-sm-3 col-form-label">Start date</label>
                                                                    <div className="col-sm-7">
                                                                        <DatePicker
                                                                            selected={startDate}
                                                                            onChange={(date) => handleDateChangeStartDate(date)}
                                                                ...
                                                                <div className="form-group row">
                                                                    <label htmlFor="dob" className="col-sm-3 col-form-label">End date</label>
                                                                    <div className="col-sm-7">
                                                                        <DatePicker
                                                                            selected={endDate}
                                                                            onChange={(date) => handleDateChangeEndDate(date)}
                                                                            dateFormat="yyyy-MM-dd"
                                                                            disabled={disabled}
                                                                            className="form-control"
