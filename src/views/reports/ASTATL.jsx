            ...
            .then((res) => {
                const tempArray = res.data.map((row) => [
                    ...
                    <div>
                        ...
                        <button type="button" disabled={isPatient} className="btn btn-danger" onClick={()=>handleDeleteAstAtl(row.id)}>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6">
                                                                <div className="form-group">
                                                                    ...
                                                                    <input disabled={disabled} type="number" required onChange={handleAstChange} value={ast} className="form-control" id="examplefbs"
                                                                           placeholder="enter AST"></input>
                                                                </div>

                                                                <div className="form-group">
                                                                    <label htmlFor="fbs">ATL value</label>
                                                                    <input disabled={disabled} type="number" required onChange={handleAtlChange} value={atl} className="form-control" id="examplefbs"
